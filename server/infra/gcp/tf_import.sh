...
terraform state rm google_global_compute_address.nakama_ip_address
...
terraform import google_global_compute_address.nakama_ip_address nakama-static-ip-address
